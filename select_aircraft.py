#This script is passed a plane from the list generated by prepare_1090_json and determines whether it should bet tweeted, and, if so, on what grounds (altitude change, location change, heading change).  It passes that information back to vamanos, which then sends the appropriate message.
import os.path
import pickle
